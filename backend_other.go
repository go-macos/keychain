...
func init() {
	...
	backendGet = func(string, string, uintptr) ([]byte, int32) { return nil, 0 }
	backendDelete = func(string, string) int32 { return 0 }
	backendNewAuthContext = func(time.Duration) (uintptr, error) { return 0, ErrUnsupported }
	backendCloseAuthContext = func(uintptr) {}
	backendCanEvaluate = func() (BiometryType, error) { return BiometryNone, ErrUnsupported }
	backendAuthenticate = func(uintptr, string) error { return ErrUnsupported }
}
